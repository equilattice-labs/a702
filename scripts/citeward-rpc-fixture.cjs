...
function createFixture(options = {}) {
  ...
  function data() {
    ...
    const mission = {
      ...
      descriptionURI: 'https://example.com/citeward/brief',
    ...
    const contributions = [
      { contributor: PENDING_CONTRIBUTOR, evidenceURI: state.unsafeEvidence ? 'javascript:alert(1)' : 'https://example.com/citeward/pending-research', approved: 0n, claimed: 0n, approvedByCreator: false },
...
// const qa = require('./scripts/citeward-rpc-fixture.cjs');
