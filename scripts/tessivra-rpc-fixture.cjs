...
function createFixture(options = {}) {
  ...
  const state = {
    ...
    briefURI: 'https://example.com/tessivra/brief',
    evidenceURI: 'https://example.com/tessivra/pending-research',
    walletBalance: '3.0',
...
// const qa = require('./scripts/tessivra-rpc-fixture.cjs');
