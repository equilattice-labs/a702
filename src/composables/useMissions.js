...
const SAVED_KEY = 'factrelle-saved';
// Newest first. Earlier brand keys are retained only for bookmark migration.
const LEGACY_SAVED_KEYS = ['inquedra-saved', 'tessivra-saved', 'vercairn-saved', 'siftlane-saved', 'citeward-saved', 'civiquill-saved', 'proofora-saved'];
