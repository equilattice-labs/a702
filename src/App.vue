  ...
  <div class="app-shell">
    ...
    >
      ...
      <nav>
        ...
        ><button @click="openGuide">
          Contributor guide<UiIcon name="book" :size="18" />
        </button>
      </nav>
    ...
    <div class="workspace" :inert="isMobile && mobileNav">
      <main id="main-content" class="main-content">
        ...
        <section class="question-banner">
          ...
          <div>
            <p>
              Turn it into a mission.<br />Give curious minds a place to start.
            </p>
            <button class="button ink" @click="startCreate">
              Create a mission<UiIcon name="arrow" :size="18" />
            </button>
          </div>
