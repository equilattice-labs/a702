# Inquedra a702 entry point

This is the distribution mirror of the [main Inquedra website](../README.md). Edit the parent source. From the parent website directory, run `npm run sync:mirror` or `npm run build:all`, then `npm run check:site`. The sync removes obsolete files from the mirror's src/public directories.
